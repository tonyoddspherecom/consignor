...
namespace Consignor.Internal
{
    internal class ShipAdvisorClient : ClientBase<IShipAdvisorAsync>, IShipAdvisorAsync
    {
        ...
        protected class ShipAdvisorChannel : ChannelBase<IShipAdvisorAsync>, IShipAdvisorAsync
        {
            ...
            public IAsyncResult BeginGetChODAllDropPointsOnMap(int webShopId, string productConceptIds, string webshopProductIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
            {
                var _args = new object[] { webShopId, productConceptIds, webshopProductIds, installationId, postCode, country, mapWidth, mapHeight };
                return base.BeginInvoke("GetChODAllDropPointsOnMap", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODAllDropPointsOnMap(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODAllDropPointsOnMap", new object[0], result)));
            }

            public IAsyncResult BeginGetChODAllDropPointsWithinBounds(int webShopId, string productConceptIds, string webshopProductIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
            {
                var _args = new object[] { webShopId, productConceptIds, webshopProductIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng };
                return base.BeginInvoke("GetChODAllDropPointsWithinBounds", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODAllDropPointsWithinBounds(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODAllDropPointsWithinBounds", new object[0], result)));
            }

            public IAsyncResult BeginGetChODCarrierDropPointsOnMap(string productConceptIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
            {
                var _args = new object[] { productConceptIds, installationId, postCode, country, mapWidth, mapHeight };
                return base.BeginInvoke("GetChODCarrierDropPointsOnMap", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODCarrierDropPointsOnMap(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODCarrierDropPointsOnMap", new object[0], result)));
            }

            public IAsyncResult BeginGetChODCarrierDropPointsWithinBounds(string productConceptIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
            {
                var _args = new object[] { productConceptIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng };
                return base.BeginInvoke("GetChODCarrierDropPointsWithinBounds", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODCarrierDropPointsWithinBounds(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODCarrierDropPointsWithinBounds", new object[0], result)));
            }
            ...
            public IAsyncResult BeginGetChODWebShopDropPointsOnMap(int webShopId, string webshopProductIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
            {
                var _args = new object[] { webShopId, webshopProductIds, installationId, postCode, country, mapWidth, mapHeight };
                return base.BeginInvoke("GetChODWebShopDropPointsOnMap", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODWebShopDropPointsOnMap(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODWebShopDropPointsOnMap", new object[0], result)));
            }

            public IAsyncResult BeginGetChODWebShopDropPointsWithinBounds(int webShopId, string webshopProductIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
            {
                var _args = new object[] { webShopId, webshopProductIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng };
                return base.BeginInvoke("GetChODWebShopDropPointsWithinBounds", _args, callback, state);
            }

            public MasterDropPointWrapper EndGetChODWebShopDropPointsWithinBounds(IAsyncResult result)
            {
                return ((MasterDropPointWrapper)(base.EndInvoke("GetChODWebShopDropPointsWithinBounds", new object[0], result)));
            }
        ...
        public IAsyncResult BeginGetChODAllDropPointsOnMap(int webShopId, string productConceptIds, string webshopProductIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODAllDropPointsOnMap(webShopId, productConceptIds, webshopProductIds, installationId, postCode, country, mapWidth, mapHeight, callback, state);
        }

        public MasterDropPointWrapper EndGetChODAllDropPointsOnMap(IAsyncResult result)
        {
            return Channel.EndGetChODAllDropPointsOnMap(result);
        }

        public IAsyncResult BeginGetChODAllDropPointsWithinBounds(int webShopId, string productConceptIds, string webshopProductIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODAllDropPointsWithinBounds(webShopId, productConceptIds, webshopProductIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng, callback, state);
        }

        public MasterDropPointWrapper EndGetChODAllDropPointsWithinBounds(IAsyncResult result)
        {
            return Channel.EndGetChODAllDropPointsWithinBounds(result);
        }

        public IAsyncResult BeginGetChODCarrierDropPointsOnMap(string productConceptIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODCarrierDropPointsOnMap(productConceptIds, installationId, postCode, country, mapWidth, mapHeight, callback, state);
        }

        public MasterDropPointWrapper EndGetChODCarrierDropPointsOnMap(IAsyncResult result)
        {
            return Channel.EndGetChODCarrierDropPointsOnMap(result);
        }

        public IAsyncResult BeginGetChODCarrierDropPointsWithinBounds(string productConceptIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODCarrierDropPointsWithinBounds(productConceptIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng, callback, state);
        }

        public MasterDropPointWrapper EndGetChODCarrierDropPointsWithinBounds(IAsyncResult result)
        {
            return Channel.EndGetChODCarrierDropPointsWithinBounds(result);
        }
        ...
        public IAsyncResult BeginGetChODWebShopDropPointsOnMap(int webShopId, string webshopProductIds, string installationId, string postCode, string country, decimal mapWidth, decimal mapHeight, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODWebShopDropPointsOnMap(webShopId, webshopProductIds, installationId, postCode, country, mapWidth, mapHeight, callback, state);
        }

        public MasterDropPointWrapper EndGetChODWebShopDropPointsOnMap(IAsyncResult result)
        {
            return Channel.EndGetChODWebShopDropPointsOnMap(result);
        }

        public IAsyncResult BeginGetChODWebShopDropPointsWithinBounds(int webShopId, string webshopProductIds, string installationId, decimal ne_lat, decimal ne_lng, decimal sw_lat, decimal sw_lng, AsyncCallback callback, object state)
        {
            return Channel.BeginGetChODWebShopDropPointsWithinBounds(webShopId, webshopProductIds, installationId, ne_lat, ne_lng, sw_lat, sw_lng, callback, state);
        }

        public MasterDropPointWrapper EndGetChODWebShopDropPointsWithinBounds(IAsyncResult result)
        {
            return Channel.EndGetChODWebShopDropPointsWithinBounds(result);
        }
